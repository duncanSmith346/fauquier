...
<header>
    ...
    if (!isset($_SESSION['logged_in'])) {
        ...
        <nav>
            <span id="nav-top">
                <span class="logo">
                    <img src="images/empowerhouse_logo.jpeg">
	...
	$current_page = strtolower(basename($_SERVER['PHP_SELF']));
        ...
        if (!isset($_SESSION['venue']) || $_SESSION['venue'] == "") {
        	echo(' <a href="' . $path . 'personEdit.php?id=' . 'new' . '">Apply</a>');
        	echo(' | <a href="' . $path . 'logout.php">Logout</a><br>');
        }
        else {
            echo('<nav>');
            echo('<span id="nav-top"><span class="logo"><a class="navbar-brand" href="' . $path . 'index.php"><img src="images/empowerhouse_logo.jpeg"></a>');
